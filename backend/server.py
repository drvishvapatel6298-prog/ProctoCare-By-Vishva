...
# ---------- Public Content ----------
SERVICES = [
    {"slug": "piles", "title": "Piles Treatment", "icon": "Stethoscope", "summary": "Painless, advanced treatment for hemorrhoids — including laser & non-surgical options.", "details": ["Laser Hemorrhoidoplasty", "Stapler Procedure (MIPH)", "Sclerotherapy & Banding", "Day-care discharge"]},
    {"slug": "fissure", "title": "Fissure Treatment", "icon": "HeartPulse", "summary": "Long-lasting relief from anal fissures with minimally invasive laser techniques.", "details": ["Laser Sphincterotomy", "Conservative Care Plan", "Diet & Lifestyle Counseling", "Quick recovery"]},
    {"slug": "fistula", "title": "Fistula Treatment", "icon": "ShieldPlus", "summary": "Sphincter-saving fistula surgery with high success rate and minimal recurrence.", "details": ["LASER FiLaC Procedure", "VAAFT Technique", "Seton Placement", "Personalised follow-up"]},
    {"slug": "laser", "title": "Laser Proctology", "icon": "Sparkles", "summary": "State-of-the-art laser procedures for fast healing and minimal post-op pain.", "details": ["Less bleeding & pain", "Day-care procedure", "Faster return to work", "Preserves sphincter function"]},
    {"slug": "consultation", "title": "In-Clinic Consultation", "icon": "Calendar", "summary": "Confidential, unhurried specialist consultation in a calm, private setting.", "details": ["Detailed assessment", "Diagnostic clarity", "Personalised treatment plan", "Follow-up included"]},
    {"slug": "online", "title": "Online Consultation", "icon": "Video", "summary": "Connect with the doctor from the comfort of your home — fully private & secure.", "details": ["Encrypted video call", "Digital prescription", "Flexible time slots", "Travel-free care"]},
]
